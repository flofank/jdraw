...
public interface DrawModel {
	...
	/**
	 * Sets the index of a given figure. If the figure is moved to a new place,
	 * then the model sends a <code>DRAWING_CHANGED</code> event to all
	 ...
	 */
	void setFigureIndex(Figure f, int index) throws IllegalArgumentException,
