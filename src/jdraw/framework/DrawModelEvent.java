...
public class DrawModelEvent extends EventObject {
	...
	public enum Type {
		...
		/**
		 * This event indicates that more than one figure has changed, e.g.\ that
		 * the order of the figures has changed. The view has to redraw the whole
		 * scene. However, no figure was added or removed.
		 */
		DRAWING_CHANGED
	}

	/** The affected figure upon which the event is reporting. */
	...
	/**
	 * Returns the figure which initiated the event. In case of a <code>DRAWING_CLEARED</code>
	 * event this method returns <code>null</code>.
	 * 
